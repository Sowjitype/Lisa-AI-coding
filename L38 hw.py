...
def temperature_prompt_activity():
  ...
  prompts = [
      f"Summarize key facts about {topic},in 3-4 sentences. make it feel like a news article.",
      f"Explain {topic} as if I'm a 10-year-old child. Use simple language and examples.",
      f"Write a pro/con list about {topic}.and give your own opinion.",
      f"Create a fictional new headlines from 2050 about {topic}.And give surprising twist in the story.",
  ]
